 ...
 */
struct User {
    static var current: User = User(userName: "Tyler-Radke", email: "Email", age: 22)
    ...
    static func logIn(user: User) {
        current = user
        print("\(current) is now logged in")
 ...
 */
let user1 = User(userName: "John Cena", email: "Cant-see-me@gmail.com", age: 45)
