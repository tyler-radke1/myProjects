...
let somePlace = GPS(lat: 51.514, long: 0.125226)
...
let favorite = Book(title: "Dracula", author: "Bram Stoker", pages: 418, price: 4.99)

print("My favorite book is \(favorite.title). It was written by \(favorite.author), it is \(favorite.pages) pages long, and you can buy it for $\(favorite.price).")
...
var lap1 = Laptop(screenSize: 40, repairCount: 2, yearPurchased: 2018)

var lap2 = Laptop(screenSize: 12, repairCount: 41, yearPurchased: 1977)
...
var height1 = Height(centimeters: 30.48)
var height2 = Height(inches: 12)
print(height1.inches)
print(height2.centimeters)
