 ...
 */
var walkingChallenge = ["Walk a lot", "Walk even more"]

var runningChallenge = ["Run a little bit", "Run 2 marathons a day"]
...
if completedChallenges.isEmpty == true {
    print("Get off your butt and do something")
} else if completedChallenges.count == 1 {
    print("You have completed the \(completedChallenges[0]) challenge.")
} else {
    print("You have completed multiple challenges")
}
