...
if let days = month["January"] {
    print("January has \(days) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray=["Circle", "Square", "Rhombus"]
var colorsArray=["Blue", "Beige", "Tan"]

var shapesDictionary=["Shapes": shapesArray, "Colors": colorsArray]

print(shapesDictionary)
...
if let color = shapesDictionary["Colors"] {
    print(color[2])
}
