...
let heart2: Double = 86
let heart3: Double = 94

let avgHeart = (heart1 + heart2 + heart3) / 3
 ...
 */
let temInFahrenheit = 98.6

let tempInCelsisus = (temInFahrenheit - 32) * (5.0/9.0)
print(tempInCelsisus)
/*:
