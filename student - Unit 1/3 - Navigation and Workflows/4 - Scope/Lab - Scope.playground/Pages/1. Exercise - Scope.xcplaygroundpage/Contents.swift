...
// Because foos' scope is within the for loop
...
//Because you have a higher scope x on line 15, then the for loop feeds the value of x into the higher scope variable
...
greeting(greeting: "Whats up", name: "Makynsleigh")

greeting(greeting: nil, name: "Dan")
