...
let family = ["Ana", "Chubbers"]

let sortedFamily = family.sorted(by: forwards)
...
let sortedFamily2 = family.sorted(by:{ (name1: String, name2: String) -> Bool in
    return name1 < name2
} )
...
let sortedFamily3 = family.sorted(by: { $0 > $1 } )
